...
export const MENU_TITLE_MAP: Record<string, string> = {
	...
	[MENU_CONFIG.GATEWAY_REGISTER]: "服务注册",
...
export const MENU_ICON_MAP: Record<string, IconName> = {
	...
	[MENU_CONFIG.GATEWAY_REGISTER]: "AppstoreAddOutlined",
		...
		children: [
			{
				...
				label: MENU_TITLE_MAP[MENU_CONFIG.GATEWAY_DATA],
			},
			{
				key: MENU_CONFIG.GATEWAY_CONFIG_MANAGE,
				icon: MENU_ICON_MAP[MENU_CONFIG.GATEWAY_CONFIG_MANAGE],
				label: MENU_TITLE_MAP[MENU_CONFIG.GATEWAY_CONFIG_MANAGE],
			},
			{
				key: MENU_CONFIG.GATEWAY_LOAD_BALANCING,
				icon: MENU_ICON_MAP[MENU_CONFIG.GATEWAY_LOAD_BALANCING],
				label: MENU_TITLE_MAP[MENU_CONFIG.GATEWAY_LOAD_BALANCING],
			},
			{
				key: MENU_CONFIG.GATEWAY_REGISTER,
				icon: MENU_ICON_MAP[MENU_CONFIG.GATEWAY_REGISTER],
				label: MENU_TITLE_MAP[MENU_CONFIG.GATEWAY_REGISTER],
			},
		],
	},
	{
